...
// Base query - collection perspective (customer collecting from suppliers)
$sql = "
    ...
    WHERE s.customer_account_id = $customer_account_id
      AND s.status != 'deleted'
";

// Apply filters
if (!empty($filters['supplier_account_code'])) {
    $supplierCode = mysqli_real_escape_string($connection, $filters['supplier_account_code']);
    $sql .= " AND sa.code = '$supplierCode' ";
}
